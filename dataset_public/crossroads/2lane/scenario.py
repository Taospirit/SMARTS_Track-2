...
agent_missions = [
    Mission(Route(begin=("edge-south-SN", 0, 50), end=("edge-west-EW", (0,), 30))),
    Mission(Route(begin=("edge-west-WE", 0, 110), end=("edge-east-WE", (0,), 30))),
    Mission(Route(begin=("edge-east-EW", 0, 50), end=("edge-west-EW", (0,), 40))),
    Mission(Route(begin=("edge-north-NS", 0, 50), end=("edge-south-NS", (0,), 40)))
]
